...
import ru.job4j.gc.prof.InsertSort;
import ru.job4j.gc.prof.MergeSort;
...
public class Menu {
    ...
    public static final String ARRAY_INFO = "Массив создан и заполнен случайными значениями от UseParallelGC.txt до ";
